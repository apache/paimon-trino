...
public abstract class TrinoMetadataBase implements ConnectorMetadata {
    ...
    public TrinoMetadataBase(TrinoCatalog catalog) {
    ...
    public TrinoTableHandle getTableHandle(ConnectorSession session, SchemaTableName tableName) {
        return getTableHandle(tableName, session, null);
    }
    ...
    public List<SchemaTableName> listTables(ConnectorSession session, Optional<String> schemaName) {
        ...
        schemaName
                ...
                .forEach(schema -> tables.addAll(listTables(schema, session)));
        return tables;
    }

    private List<SchemaTableName> listTables(String schema, ConnectorSession session) {
        try {
            catalog.setSession(session);
