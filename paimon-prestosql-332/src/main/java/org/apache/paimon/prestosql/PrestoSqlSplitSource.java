...
/** PrestoSql {@link PrestoSqlSplitSourceBase}. */
public class PrestoSqlSplitSource extends PrestoSqlSplitSourceBase {

    public PrestoSqlSplitSource(List<PrestoSqlSplit> splits) {
        super(splits);
    }
